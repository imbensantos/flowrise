...
const components: JSXMapSerializer = {
  heading2: ({ children }) => (
    <Heading className="text-slate-700 font-display text-[2.5rem] font-semibold leading-[3.5rem] mb-9 lg:mb-14">
      {children}
    </Heading>
  ),
  paragraph: ({ children }) => (
          ...
          testimonial ? (
            ...
            >
              ...
              <footer className="flex gap-4 items-center">
                ...
                />
                <div>
                  <p className="text-slate-700 font-medium font-body text-base text-left">
                    {testimonial.data.name}
                  </p>
                  <p className="text-slate-500 font-body text-base text-left">
